...
namespace ATSPM.Application.Models
{
    ...
    {
        //[NotMapped]
        //public HtmlListInfo htmlListInfo = new HtmlListInfo(HtmlTag.table, 2, new { @class = "class_name" },
        ...
        {
            var result = false;
            if(DetectionTypeDetectors != null)
            {
                foreach (var dt in DetectionTypeDetectors)
                {
