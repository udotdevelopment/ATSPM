...
While each agency should consult with their IT department for specific guidelines on how to best deliver a secure, stable and responsive solution, we can estimate that most mid-range to high-end servers will be able to handle the task of hosting and creating metrics for most agencies."
            ...
            new Models.Menu { MenuId = 56, MenuName = "Database Archive Settings", Controller = "ArchiveSettings", Action = "Index", ParentId = 11, Application = "SignalPerformanceMetrics", DisplayOrder = 7 }
            );
  ...
  new Models.VersionAction { ID = 10, Description = "Initial" }
            ...
            context.DatabaseArchiveSettings.AddOrUpdate(
                c => c.ApplicationID,
                new Models.DatabaseArchiveSettings{ ApplicationID = 3,
