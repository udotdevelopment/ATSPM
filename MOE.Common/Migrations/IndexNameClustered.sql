...
/***
 SELECT [dbo].[IndexNameClustered](1, 1)
 SELECT [dbo].[IndexNameClustered](1, 2)

 SELECT [dbo].[IndexNameClustered] (2, 1)
 SELECT [dbo].[IndexNameClustered] (2, 2)
 SELECT [dbo].[IndexNameClustered] (2, 3)
 ***/
