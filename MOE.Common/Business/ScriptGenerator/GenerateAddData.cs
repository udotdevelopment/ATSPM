        ...
        public static void CreateScript()
        {
            ...
            foreach (var pin in pins)
            {
                ...
                script +=
                    ...
                    "),{icon:iconURL,width:'23px',height:'22px',anchor:new Microsoft.Maps.Point(11, 11)});" + PinName +
                    ...
                    "Microsoft.Maps.Events.addHandler(" + PinName + ", 'click', displayInfobox);dataLayer.push(" +
                    PinName + ");}";
            }
            script += "}";
        ...
        public static void CreateRouteScript()
        {
            ...
            foreach (var pin in pins)
            {
                ...
                script +=
                    ...
                    pin.Latitude + ", " + pin.Longitude +
                    "),{icon: iconURL, width: '23px',  height: '22px',anchor: new Microsoft.Maps.Point(11, 11)});" +
                    ...
                    ", 'click', AddSignalFromPin);dataLayer.push(" + PinName + ");}";
            }
