...
namespace MOE.Common.Business
{
    public class PlanSplitMonitor:Plan
    {
        ...
        public void SetProgrammedSplits(string signalId)
        {
            ...
            ControllerEventLogs splitsDt = new ControllerEventLogs(signalId, StartTime, StartTime.AddSeconds(2), l);
            foreach (Models.Controller_Event_Log row in splitsDt.Events)
            {
        ...
        public void SetHighCycleCount(AnalysisPhaseCollection phases)
        {
            ...
            foreach (AnalysisPhase phase in phases.Items)
            {
