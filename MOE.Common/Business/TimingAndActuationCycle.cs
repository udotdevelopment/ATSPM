...
namespace MOE.Common.Business
{
    ...
    {
        public TimingAndActuationCycle(DateTime startGreen, DateTime endMinGreen, DateTime startYellow, DateTime startRedClearance, DateTime startRed, DateTime endRed)
        {
