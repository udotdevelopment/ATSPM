...
namespace MOE.Common.Business.Export
{
    ...
    {
        // TODO: When we re-implement  export, this entire section needs to be reworked.
        ...
        //public AdvancedExport(DateTime startDate, DateTime endDate, List<string> DayOfweek, 
        //    string signalId, string location, int volumeBinSize)
        //{
        //    BuildDateList(startDate, endDate, DayOfweek, 
        //    signalId, location, volumeBinSize);
        //}
