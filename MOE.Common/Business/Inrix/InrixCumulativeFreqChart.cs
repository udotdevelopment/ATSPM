...
namespace MOE.Common.Business.Inrix
{
    public class InrixCumulativeFreqChart
    {
        ...
        {
            var tmcCode = new DataColumn();
            var tmcName = new DataColumn();
            var tmcLength = new DataColumn();
            var timeRangeID = new DataColumn();
            var timeRange = new DataColumn();
            var avgTT = new DataColumn();
            var stdDev = new DataColumn();
            var percGoodBins = new DataColumn();
            var avgConfidence = new DataColumn();
        ...
        public void AddRowsToTable(string tmc_code, string range, double avg_tt, double std_dev, double perc_good_bins,
            double avg_confidence)
        {
            InrixReliabilityDT.Rows.Add(tmc_code, range, avg_tt.ToString("N0"), std_dev.ToString("N0"),
