...
namespace AtspmApi.Repositories
{
    public class SignalsRepository : ISignalsRepository
    {
        ...
        public SignalsRepository(Models.AtspmApi context)
        {
            _db = context;
        }
        ...
        public Signal GetSignalWithApproachesBySignalID(string signalId)
        {
            ...
            //{
            //    AddSignalAndDetectorLists(returnSignal);  //CANNOT do detectors yet! TODO!
            //}
            return returnSignal;
        }
        ...
        {
            var detectionTypesRepository = AtspmApi.Repositories.DetectionTypeRepositoryFactory.Create();
            var detectionTypes = detectionTypesRepository.GetAllDetectionTypes();
            var hardwareTypesRepository =
                AtspmApi.Repositories.DetectionHardwareRepositoryFactory.Create();
