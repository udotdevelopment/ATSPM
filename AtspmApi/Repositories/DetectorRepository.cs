...
namespace AtspmApi.Repositories
{
    public class DetectorRepository : IDetectorRepository
    {
        ...
        public DetectorRepository(Models.AtspmApi context)
        {
            _db = context;
        ...
        Models.AtspmApi IDetectorRepository.GetContext()
        {
    ...
    //This method probably doesn't really belong here anymore.
        //public List<AtspmApi.Models.Detectors> GetDetectorsBySignalID(string SignalID)
        //{
        //    MOE.Common.Business.ModelObjectHelpers.SignalModelHelper smh = new Business.ModelObjectHelpers.SignalModelHelper(SignalId);

        //    List<AtspmApi.Models.Detectors> detectors = smh.GetDetectorsForSignal();

        //    return detectors;
        //}
        //This method probably doesn't really belong here anymore.
        //public List<AtspmApi.Models.Detectors> GetDetectorsBySignalIDAndPhase(string SignalId, int PhaseNumber)
        //{
        //    MOE.Common.Business.ModelObjectHelpers.SignalModelHelper smh = new Business.ModelObjectHelpers.SignalModelHelper(SignalId);

        //    List<int> phases = smh.GetPhasesForSignal();

        //    List<AtspmApi.Models.Detectors> detectors = new List<Detectors>();

        //    foreach(int p in phases)
        //    {
        //        foreach(AtspmApi.Models.Lane l in p.LaneGroups.FirstOrDefault().Lanes)
        //        {
