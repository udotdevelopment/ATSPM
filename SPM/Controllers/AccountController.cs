...
namespace SPM.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        private SPMUserManager _userManager;

        public AccountController()
        {
        }

        public AccountController(SPMUserManager userManager, SPMSignInManager signInManager )
        {
        ...
        public SPMUserManager UserManager
        {
            get
            {
                return _userManager ?? HttpContext.GetOwinContext().GetUserManager<SPMUserManager>();
            }
            private set
            {
                _userManager = value;
        ...
        public async Task<ActionResult> Register(RegisterViewModel model)
        {
            if (ModelState.IsValid)
            {
                var user = new SPMUser { UserName = model.Email.ToLower(), Email = model.Email.ToLower() };
        ...
        public async Task<ActionResult> ExternalLoginConfirmation(ExternalLoginConfirmationViewModel model, string returnUrl)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                var user = new SPMUser { UserName = model.Email, Email = model.Email };
