...
namespace SPM.Controllers
{
    ...
    public class RouteOldController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "RouteId,RouteName")] Route approachRoute)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "RouteId,RouteName")] Route approachRoute)
        {
            if (ModelState.IsValid)
            {
