(function () {
    ...
    angular
        .module('MyApp')
        .controller('versionAddController', versionAddController);

    /** @ngInject */
    function versionAddController($scope, $mdDialog, params, $http, $mdToast) {

        var vm = this;
        vm.signal = params.signal;
        vm.close = close;
        vm.saveSignal = saveSignal;
        vm.notUsaDialog = notUsaDialog;
        vm.hasLatLng = false;
        vm.mapApi = {};
        vm.lookups = params.lookups;
        vm.mapOpen = false;
